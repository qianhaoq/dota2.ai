...
function isMajorPurchase(key, itemConstants = null) {
  ...
  // Consumables / known minor parts (and fallback when constants absent).
...
export { isMajorPurchase, formatItemTime, CONSUMABLE_OR_COMPONENT, STANDALONE_MAJOR_PURCHASES, DOTABUFF_SLUG_BY_INTERNAL, buildRecipeComponentKeySet };
