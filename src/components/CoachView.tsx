    ...
    <div className="flex flex-col h-full min-h-0 bg-k3-base overflow-hidden">
      ...
      {detailHeroId && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-0 sm:p-4">
          <div className="relative w-full h-full sm:h-auto sm:max-w-4xl sm:max-h-[90vh] min-h-0 bg-k3-surface sm:rounded-2xl border-0 sm:border sm:border-k3-border-subtle overflow-hidden flex flex-col pt-safe pb-safe">
            <button
              type="button"
