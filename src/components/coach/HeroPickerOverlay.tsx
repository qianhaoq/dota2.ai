        ...
        <div className="px-4 py-3 border-t border-k3-border-subtle bg-k3-base">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <div className="flex gap-1">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={`rad-preview-${i}`} className="w-7 h-7 rounded-sm bg-k3-surface border border-k3-border-subtle overflow-hidden">
                    {draft.radiant[i] && (
            ...
            <div className="flex items-center gap-2">
              <div className="flex gap-1">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={`dire-preview-${i}`} className="w-7 h-7 rounded-sm bg-k3-surface border border-k3-border-subtle overflow-hidden">
                    {draft.dire[i] && (
