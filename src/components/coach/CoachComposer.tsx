...
const CoachComposer: React.FC<CoachComposerProps> = ({
  ...
  return (
    <div className="flex-shrink-0 border-t border-k3-border-subtle bg-k3-base pb-[max(0.75rem,env(safe-area-inset-bottom,0px))]">
      <div className="max-w-3xl mx-auto w-full px-3 sm:px-4 pt-2 sm:pt-3">
        ...
        <div className="hidden sm:block text-center text-[10px] leading-4 text-k3-text-tertiary/60 tracking-wide mt-1.5 pb-0.5">
