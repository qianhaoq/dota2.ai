...
/** Compact fingerprint of structured review-card growth during an in-flight review stream. */
function reviewCardsGrowthFingerprint(reviewCards?: ReviewCardsPayload | null): string {
